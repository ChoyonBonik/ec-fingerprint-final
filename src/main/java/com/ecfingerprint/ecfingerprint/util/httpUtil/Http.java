...
public abstract class Http {
    ...
    protected void setRequestByteBody() throws IOException {
        if (parameter.getRequestByteBody() != null) {
            connection.setDoOutput(true);

            DataOutputStream outputStream = new DataOutputStream(connection.getOutputStream());
            outputStream.write(parameter.getRequestByteBody());
            outputStream.flush();
            outputStream.close();
        }
    }
    ...
    public abstract Http setByteBody(byte[] body);
